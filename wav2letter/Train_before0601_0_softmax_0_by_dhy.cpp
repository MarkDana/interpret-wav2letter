...
int main(int argc, char** argv) {
  ...
  preOutFile.close();
      ...
      auto addpreOutput = fl::Variable(af::matmul(zerowgt, preOutput.array()), false);
        ...
        auto softmax_preOutput = fl::softmax(addpreOutput,0);
        auto softmax_add_preOutput = fl::Variable(af::matmul(zerowgt, softmax_preOutput.array()), false);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//LOG(INFO)<<af::toString("rawinput 6 values:",rawinput(af::seq(6)));
      ...
      if(nowOutFile.is_open())
      {
        ...
        auto softmax_output = fl::softmax(addoutput,0);
